    ...
    >
      ...
      >
        ...
        <Box display="flex" margin=" 20px 0px" justifyContent="flex-start" alignItems="center">
          <img src={gitInfo.avatar_url} alt={`imagem de ${gitInfo.login}`} style={{ width: '50px', borderRadius: '25px', margin: '0px 20px' }} />
        ...
        <Box marginLeft="20px" style={{ cursor: 'pointer' }}>
          <Text href={gitInfo.html_url} color="secondary.main">
            <img src="/images/assets/github.png" alt="github logo" />
            GitHub
          </Text>
        </Box>
      </Box>
